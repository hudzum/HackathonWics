...
import { LogOut, User, Settings, Home, PlusCircle, HandCoins } from "lucide-react";
    ...
    <div className="drop-shadow-lg sticky top-0 z-50 w-full border-b backdrop-blur-md bg-background/80 flex flex-row items-center justify-between px-6 py-2">
      <div className="flex items-center">
        <NavLink to="/" className="flex items-center space-x-2">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white font-extrabold text-xl rounded-lg px-3 py-1">
